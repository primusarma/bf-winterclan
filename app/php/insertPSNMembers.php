<?PHP
	...
	mysql_query("INSERT INTO psnmembers (id, data) VALUES('NULL', '$p')") or die(mysql_error());
	mysql_query("DELETE FROM psnmembers WHERE id < (select t.id FROM (SELECT * FROM psnmembers) as t ORDER BY id DESC LIMIT 2,1);") or die(mysql_error());
